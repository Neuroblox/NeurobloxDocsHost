...
g = GraphSystem()
add_connection!(g, fsi, IndegreeConstrainedRule(; weight = weight_FSI_MSN, density = density_FSI_MSN), msn)
...
g = GraphSystem()
add_connection!(g, fsi, IndegreeConstrainedRule(; weight = weight_FSI_MSN, density = density_FSI_MSN), msn)
add_connection!(g, msn, IndegreeConstrainedRule(; weight = weight_MSN_GPe, density = density_MSN_GPe), gpe)
add_connection!(g, gpe, IndegreeConstrainedRule(; weight = weight_GPe_STN, density = density_GPe_STN), stn)
add_connection!(g, stn, IndegreeConstrainedRule(; weight = weight_STN_FSI, density = density_STN_FSI), fsi)
